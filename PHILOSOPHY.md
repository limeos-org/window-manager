<picture>
  ...
  <source media="(prefers-color-scheme: dark)" srcset=".assets/philosophy_banner/dark_mode.png">
  <source media="(prefers-color-scheme: light)" srcset=".assets/philosophy_banner/light_mode.png">
  <!-- Fallback to light mode variant if no match -->
  <img alt="LimeOS Banner" src=".assets/philosophy_banner/light_mode.png">
</picture>
...
a lasting good. In LimeOS, each virtue serves as a compass when making
tradeoffs.
